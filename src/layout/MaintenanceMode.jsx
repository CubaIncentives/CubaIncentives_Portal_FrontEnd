...
const MaintenanceMode = () => {
  ...
  return (
    <div className='h-screen bg-cover bg-center'>
      <Helmet>
        <meta charSet='utf-8' />
        <title>Under Maintenance {PAGE_TITLE_SUFFIX}</title>
      </Helmet>
      <div className='w-full h-screen flex flex-col items-center justify-between'>
        <div className='w-full py-4 border-t border-gray-300'>
          <div className='container mx-auto flex flex-col md:flex-row items-center justify-center text-gray-600 text-sm md:space-x-8 space-y-1 md:space-y-0'>
            <img
              src={logo}
              alt='logo'
              className='max-w-36 max-h-16 w-screen h-screen'
            />
          </div>
        </div>
        <div className='xl:w-1/2 flex-1 flex flex-col items-center justify-center text-center px-4 lg:px-0'>
          ...
          <button
            ...
            className=' sm:w-full  lg:w-auto my-4 drop-shadow-md shadow-xl hover:drop-shadow-none outline-none rounded md py-2 px-8 text-center hover:bg-indigo-400 text-white bg-indigo-600'
          >
            Check for Updates
          </button>
        </div>
